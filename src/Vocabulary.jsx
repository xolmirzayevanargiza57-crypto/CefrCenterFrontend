...
const CATEGORY_META = {
  ...
  nature:     { icon: CloudSun,      accent: '#10b981', bg: 'rgba(16,185,129,0.10)'  },
  travel:     { icon: Search,        accent: '#f59e0b', bg: 'rgba(245,158,11,0.10)'  },
  technology: { icon: Hash,          accent: '#8b5cf6', bg: 'rgba(139,92,246,0.10)'  },
  emotions:   { icon: Cherry,        accent: '#ec4899', bg: 'rgba(236,72,153,0.10)'  },
  education:  { icon: GraduationCap, accent: '#6366f1', bg: 'rgba(99,102,241,0.10)'  },
  health:     { icon: Brain,         accent: '#ef4444', bg: 'rgba(239,68,68,0.10)'   },
  business:   { icon: Users,         accent: '#3b82f6', bg: 'rgba(59,130,246,0.10)'  },
  house:      { icon: Utensils,      accent: '#64748b', bg: 'rgba(100,116,139,0.10)' },
